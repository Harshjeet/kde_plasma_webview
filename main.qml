    ...
    fullRepresentation: ColumnLayout {
        ...
        RowLayout{
            ...
            RowLayout {
                ...
                //space btwn url and loading
                Item {
                    Layout.fillWidth: true
                }

                // loading bar right allign
                PlasmaComponents3.Label {
                    id: loadingPercentage
                    Layout.rightMargin: Kirigami.Units.smallSpacing
                    visible: webview.loading
                    text: webview.loadProgress + "%"
                }
            ...
            //     // text: webview.url
            //     text: webview.loading ? (webview.url + " (" + webview.loadProgress + "%)") : webview.url
...
//                 id: newTabButton
//                 text: "+"
//                 onClicked: addNewTab("https://www.kde.org/") // Default new tab URL
//             }

//             function addNewTab(url) {
//                 var newTab = tabComponent.createObject(tabView, { tabUrl: url });
//                 tabView.addTab(newTab);
//                 tabView.currentIndex = tabView.count - 1; // Switch to new tab
//             }
...
//                     title: "New Tab"
//                     closePolicy: QQC2.Tab.CloseOnHover
//                     onClosed: destroy()
...
//                                 tabView.addNewTab(request.url); // Open link in new tab
//                                 request.accepted = false;
//                             }
//                         }

//                         onUrlChanged: {
//                             title = webview.title.length > 0 ? webview.title : "Loading...";
//                         }

//                         onLoadProgressChanged: {
//                             loadingPercentage.text = loadProgress + "%";
//                         }

//                         onLoadingChanged: loadingInfo => {
//                             if (loadingInfo.status === WebEngineLoadingInfo.LoadStartedStatus) {
//                                 loadingPercentage.visible = true;
...
// }
            ...
            WebEngineView {
                ...
                onLoadProgressChanged: {
                    loadingPercentage.text = webview.loadProgress + "%";  // Update percentage dynamically
                }
